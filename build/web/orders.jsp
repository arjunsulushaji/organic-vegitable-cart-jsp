        ...
        <div class="login">
            <div class="container">
                ...
                <table class="table" style="margin-top: 25px;">
                 ...
                 String sele="SELECT *FROM orders where UID='"+ID+"' and ORDERSTATUS='true' order by ORDERID desc ";
                  ...
                  while(rs.next()) 
                  {
                        ...
                        <tr>
                            ...
                            <th scope="row"><%=rs.getString(11)%></th>
                                <%
                                    if(rs.getString(12).equals("order placed"))
                                    {
                                %>
                            <th scope="row" style="color:#fe9126;"><%=rs.getString(12)%></th>
                                <%
                                    } else {
                                %>
                            <th scope="row" style="color: limegreen;"><%=rs.getString(12)%></th>
                                <%
                                    }
                                %>
                        </tr>
