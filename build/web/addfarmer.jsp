...
<html>
    ...
    <body>
        ...
        <div class="register">
            <div class="container">
                ...
                <div class="login-form-grids">
                    <form action="addfarmernext.jsp" method="post" id="add-farmer-form">
                        ...
                        <input type="number" placeholder="Farmer Mobilel Number" id="mobno" required="" name="MOBNO">
                        ...
                        <select name="DISTRICT" id="" class="mt-2" style="width: 244px;
                                height: 38px;
        ...
        <script>
            $(document).ready(() => {
                $("#add-farmer-form").submit(function (e) {
                    var digit = $('#mobno').val();
                    if (digit.length != 10) {
                        $("#error").show();
                        e.preventDefault();
