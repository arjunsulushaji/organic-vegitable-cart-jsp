<%  
    ...
    String s="update orders set ORDERSTATUS='true' where UID='"+USERID+"' ";
    String ss="delete from cart where USERID='"+USERID+"' ";
...
<html>
    ...
    <body>
        ...
        <div class="register">
            <div class="container">
                <h2 style="margin-top: 4rem; color: limegreen">Order placed Successfull</h2>            
